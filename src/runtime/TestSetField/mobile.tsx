...
const FormField: IFormField = {
  ...
  habdlClick(item: { name: any; size: any; unit: any }) {
    ...
    this.setState(
      ...
      () => {
        form.setFieldValue('TestSet', item.name);
  ...
  onInputchange(types, index, e) {
    ...
    arr[newindex].notax_price =
      arr[newindex].refer_price * arr[newindex].tax_rate;
  ...
  fieldDidUpdate() {
    if (!this.props.runtimeProps.viewMode) {
      ...
      const { form } = this.props;
      form.setFieldValue('TestSetField', editData);
      form.setExtendFieldValue('TestSetField', {
        data: editData,
      });
    }
  },
                ...
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e => this.onInputchange('need_quantity', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e => this.onInputchange('refer_price', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
