                ...
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('oil_consump', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  <div className="label">油价</div>
                  <div>
                    <InputItem
                      clear
                      value={item.price}
                ...
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('total_price', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
