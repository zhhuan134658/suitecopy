...
const FormField: IFormField = {
  ...
  fieldDidUpdate() {
    if (!this.props.runtimeProps.viewMode) {
      ...
      const { form } = this.props;
      form.setFieldValue('TestLeconField', editData);
      form.setExtendFieldValue('TestLeconField', {
        data: editData,
      });
    }
  },
                ...
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('zh_plan_quantity', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  <div className="label">需用数量</div>
                  <div>
                    <InputItem
                      clear
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('need_quantity', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
                ...
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('refer_price', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      value={item.subtotal}
                      placeholder="请输入"
                      onChange={e => this.onInputchange('subtotal', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
