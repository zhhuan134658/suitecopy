...
const FormField: IFormField = {
  ...
  fieldDidUpdate() {
    if (!this.props.runtimeProps.viewMode) {
      ...
      const { form } = this.props;
      form.setFieldValue('TestScienceField', editData);
      form.setExtendFieldValue('TestScienceField', {
        data: editData,
      });
    }
  },
                ...
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e => this.onInputchange('wz_number', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      value={item.price}
                      placeholder="请输入"
                      onChange={e => this.onInputchange('price', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
