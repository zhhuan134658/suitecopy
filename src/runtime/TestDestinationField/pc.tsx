...
//     form.setFieldValue('TestDestination', e.target.value);
//   },

//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestDestination');
//     const label = form.getFieldProp('TestDestination', 'label');
//     const placeholder = form.getFieldProp('TestDestination', 'placeholders');
...
const FormField: ISwapFormField = {
  ...
  handleSave(row: DataType) {
    ...
    //   form.setFieldValue('TestDestination', newData);
    //   form.setExtendFieldValue('TestDestination', {
    //     data: newData,
    //   });
    // }
  ...
  asyncSetFieldProps(vlauedata) {
    ...
    const TestDestinationField = form.getFieldInstance('TestDestination');

    // const leaveReasonField = form.getFieldInstance('leaveReason');
    const key = TestDestinationField.getProp('id');
    // const value = TestDestinationField.getValue();
    const value = '1';

    // const extendValue = TestDestinationField.getExtendValue();
    const bizAsyncData = [
      {
        key,
    ...
    spi
      .refreshData({
        modifiedBizAlias: ['TestDestination'], // spi接口要改动的是leaveReason的属性值
        bizAsyncData,
      })
      .then(res => {
        ...
        //   res.dataList,
        //   item => item.bizAlias === 'TestDestination',
        // );
  ...
  rowClick(this, record, rowkey) {
    ...
    this.setState({ dataSource: newData, isModalVisible: false }, () => {
      form.setFieldValue('TestDestination', record);
      form.setExtendFieldValue('TestDestination', {
        record: record,
  ...
  fieldDidUpdate() {
    ...
    const { form } = this.props;
    form.setFieldValue('TestDestination', editData);
    form.setExtendFieldValue('TestDestination', {
      data: editData,
    });
  ...
  fieldRender() {
    ...
    const field = form.getFieldInstance('TestDestination');
    console.log('wwwwwwwwwwwwwwwwwww', field);
    const label = form.getFieldProp('TestDestination', 'label');
    const placeholder = form.getFieldProp('TestDestination', 'placeholder');
    const required = form.getFieldProp('TestDestination', 'required');
