...
const FormField: ISwapFormField = {
  ...
  handleSave(row: DataType, values) {
    ...
    //   form.setFieldExtendValue('TestOrder', {
    //     data: newData,
    //   });
    // }
  ...
  asyncSetFieldProps(vlauedata) {
    ...
    // const value = TestOrderfield.getExtendValue();
    const value = '1';
  ...
  fieldDidUpdate() {
    if (!this.props.runtimeProps.viewMode) {
      ...
      let str0 =
        '\n' +
        '设备名称 单位 规格型号 数量 不含税单价 含税单价 税率 税额 不含税金额 含税金额 已入库量 总计划量';
      let str1 =
        '\n' +
        '不含税金额合计(元):' +
