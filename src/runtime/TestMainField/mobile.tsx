...
const FormField: IFormField = {
  ...
  onInputchange(types, index, e) {
    ...
    arr[newindex].total_price =
      arr[newindex].material_total + arr[newindex].person_total;
  ...
  fieldDidUpdate() {
    if (!this.props.runtimeProps.viewMode) {
      ...
      const { form } = this.props;
      form.setFieldValue('TestMainField', editData);
      form.setExtendFieldValue('TestMainField', {
        data: editData,
      });
    }
  },
          ...
          {this.state.materialList.map((item, index) => {
            return (
              <List>
                ...
                <List.Item>
                  <div className="label">维保内容</div>
                  <div>
                    <InputItem
                      clear
                      value={item.content}
                      placeholder="请输入"
                      onChange={e => this.onInputchange('content', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  <div className="label">工时数</div>
                  <div>
                    <InputItem
                      clear
                      value={item.hours}
                      placeholder="请输入"
                      onChange={e => this.onInputchange('hours', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>

                <List.Item>
                  <div className="label">人工合价</div>
                  <div>
                    <InputItem
                      clear
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('person_total', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  <div className="label">材料合价</div>
                  <div>
                    <InputItem
                      clear
                      ...
                      placeholder="请输入"
                      onChange={e =>
                        this.onInputchange('material_total', index, e)
                      }
                    ></InputItem>
                  </div>
                </List.Item>
                <List.Item>
                  ...
                  <div>
                    <InputItem
                      ...
                      placeholder="请输入"
                      onChange={e => this.onInputchange('operation', index, e)}
                    ></InputItem>
                  </div>
                </List.Item>
              </List>
